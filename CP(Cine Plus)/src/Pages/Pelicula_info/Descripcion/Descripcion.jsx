        ...
        <div className='CalendarioContainer'>
          ...
          <div className='FuncionesContainer'>
            {funciones.map(funcion => (
              <Link
                key={funcion.id}
                className='funcionlink'
                to={`/reserva?movieId=${pelicula.id}&dimension=${dimension}&doblaje=${doblaje}&entryTime=${funcion.hora}`}
              >
                <div className="button funcion">{funcion.hora}</div>
              </Link>
            ))}
          </div>
        </div>
